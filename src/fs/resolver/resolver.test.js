...
createFolder.mockImplementation((directory, name) => formatAction('create', 'end', 'folder', name));
...
moveFile.mockImplementation((directory, name) => formatAction('move', 'end', 'file', name));
